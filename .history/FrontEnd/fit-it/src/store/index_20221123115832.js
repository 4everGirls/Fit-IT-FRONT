  ...
  actions: {
    ...
    joinChallenge({ commit }, joinInfo) {
      ...
      axios({
        ...
        .then(() => {
          const API_URL2 = `${REST_API}/challengeApi/detailChallenge/${joinInfo.challengeNo}`;
          axios({
            url: API_URL2,
            method: "GET",
          })
    ...
    notJoinChallenge({ statcommit }, notJoinInfo) {
      commit;
      ...
      axios({
        ...
        .then(() => {
          const API_URL2 = `${REST_API}/challengeApi/detailChallenge/${notJoinInfo.challengeNo}`;
          axios({
            url: API_URL2,
            method: "GET",
          })
