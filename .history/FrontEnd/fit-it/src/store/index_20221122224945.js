...
export default new Vuex.Store({
  ...
  actions: {
    ...
    inDetailGetMissionList({ commit }, challengeNo) {
      const API_URL = `${REST_API}/challengeApi/detailMission/PathVariable${challengeNo}`;
    ...
    joinChallenge({state, commit}, joinInfo) {
      ...
      const API_URL = `${REST_API}/challengeApi/joinChallenge/${joinInfo.challengeNo}/${joinInfo.}`;
