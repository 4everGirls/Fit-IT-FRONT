<template>
  <div>
    ...
    <book-mark></book-mark>
    <mission-coment-list></mission-coment-list>
    <write-mission-coment></write-mission-coment>
    <side-bar></side-bar>
  </div>
</template>
...
import MissionVideo from '@/components/challenge/DoChallenge/MissonVideo.vue';
