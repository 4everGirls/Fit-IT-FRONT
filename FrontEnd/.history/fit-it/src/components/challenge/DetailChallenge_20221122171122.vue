  ...
  <div class="row m-4">
    ...
    <div class="col " >
        <div class="row">
          ...
          <div class="col">
            <button class="btn btn-primary" @click="deleteChallenge(mychallenge.challengeNo)">챌린지 참여하기</button>
          </div>
        </div>
        ...
        <div class="row">
            <li class="col m-4" v-for="(mission, index) in indetailGetMissionList" :key="index">
                - {{ mission.videoTitle }} 
