<template>
  <div>
    ...
    <div v-if="isNotEmpty">
      ...
      <div class="row">
        <div id="show-all" class="ms-0 d-flex flex-col justify-content-end">
              ...
              >
                <div class="box">
                  <div class="row">
                    ...
                    <div class="col-3"></div>
                    <div class="col-2 continue">
                      <!--참여중 / 완료 이미지-->
                      <div class="row complete-img">
                      ...
                      <div class="row">
                        <button class="btn btn-primary">
                          <img src="@/assets/img/fast-forward-white.png" width="20px"> 이어하기
                        </button>
                      </div>
                    </div>
                  </div>
