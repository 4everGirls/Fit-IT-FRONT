    ...
    <form class="row g-3">
      ...
      <div class="col">
        ...
        <div class="row mb-5">
          ...
          >
          <div class="col-sm-7">
            <input type="password" class="form-control" id="passwordConfirm" placeholder="비밀번호를 한 번 더 입력하세요."/>
          </div>
        </div>
        <div class="row mb-5">
        ...
        <div class="row mb-5">
          <label for="birth" class="col-sm-3 col-form-label">키</label>
          <div class="col-sm-7">
            <input type="number" class="form-control" id="birth" placeholder="cm" />
          </div>
        </div>
        <div class="row mb-5">
          <label for="birth" class="col-sm-3 col-form-label">몸무게</label>
          <div class="col-sm-7">
            <input type="number" class="form-control" id="birth" placeholder="kg" />
          </div>
        </div>
        <!--button-->
